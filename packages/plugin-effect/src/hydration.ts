/**
 * Server-side atom hydration helpers for effectPlugin().
 *
 ...
 *
 * Called by the atom hydration hook registered in effectPlugin().
 */
 ...
 * Called by effectPlugin() middleware before ctx.next() on every request.
 */
